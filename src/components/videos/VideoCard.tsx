...
const VideoCard: React.FC<VideoCardProps> = ({ video }) => {
  ...
  return (
    <div className="group bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:border-red-200">
      {/* Thumbnail */}
      ...
      <div className="p-6">
        ...
        {/* Title */}
        <h3 className="font-semibold text-lg mb-2 text-gray-800 line-clamp-2 group-hover:text-red-700 transition-colors">
          {video.title}
        </h3>
        ...
        <div className="text-sm text-gray-600 mb-3">
          ...
          <p>{video.course} {video.semester && `• ${video.semester}`}</p>
        </div>
